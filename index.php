...
<section class="featured">
    <div class="container featured__container">
        ...
        <div class="post__info">
            <a href="categoy-posts.php" class="category__button">Wildlife</a>
            <h2 class="post_title"><a href="post.php">Junk food can be healthy!?</a></h2>
            <p class="post__body">junk food can be a good source of folate, 
                vitamin A, vitamin B6, vitamin Bi2, protein, calcium, iron, and other
                 essential nutrients. Surprised?</p>
            <div class="post__author">
                ...
                <div class="post__author-info">
                    <h5>By: Megha</h5>
                    <small>November 11, 2022 - 05:03</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container posts__container">
        ...
        <article class="post">
            <div class="post__thumbnail">
                ...
                <div class="post__info">
                    <a href="" class="category__button">Uncategorized</a>
